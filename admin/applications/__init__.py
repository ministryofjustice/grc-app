...
def search_by_reference_number():
    ...
    if form.reference_number.data:
        if reference_number_is_valid_admin(form.reference_number.data):
...
def download(reference_number):
    ...
    if application is None:
        ...
        bytes_, file_name = ApplicationFiles().create_pdf_admin_with_files_attached_new(application.application_data())
