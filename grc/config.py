...
class Config:
    ...
    ONE_LOGIN_REFERENCE_LOGOUT_REDIRECT_URI = os.environ.get("ONE_LOGIN_REFERENCE_LOGOUT_REDIRECT_URI")
    ONE_LOGIN_DID_URL = os.environ.get("ONE_LOGIN_DID_URL")
    ONE_LOGIN_SAVE_AND_EXIT_REDIRECT_URI = os.environ.get('ONE_LOGIN_SAVE_AND_EXIT_REDIRECT_URI')
    ONE_LOGIN_CONFIRMATION_LOGOUT_REDIRECT_URI = os.environ.get('ONE_LOGIN_CONFIRMATION_LOGOUT_REDIRECT_URI')
