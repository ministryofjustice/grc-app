...
class GovUkNotifyTemplates:
    ...
    def get_admin_forget_password_template_id(self):
        return 'fadf94d8-7d65-4eed-b52a-5f5b81aa32be'

    def get_admin_new_user_template_id(self):
        return '0ff48a4c-601e-4cc1-b6c6-30bac012c259'

    def get_feedback_template_id(self):
    ...
    def get_security_code_template_id(self):
        if g.lang_code == 'cy':
