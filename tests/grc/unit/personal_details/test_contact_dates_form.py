...
from tests.grc.helpers.data import remove_date_ranges, single_date_mock, date_range_mock
...
class TestContactDatesForm:
    ...
    def test_contact_single_date_range_invalid_inputs(self, app):
        with app.test_request_context():
            ...
            date_range_mock(date_range_form, invalid_from_date, invalid_to_date, from_day='', to_year='100')
            contact_dates_form.date_ranges.append_entry(date_range_form)
