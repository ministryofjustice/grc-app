...
async def run_checks_on_section(page: Page, asserts: AssertHelpers, helpers: PageHelpers):
    ...
    await asserts.check_your_answers_row('Enw adeg geni')
    await asserts.check_your_answers_row('Dyddiad geni')
    await asserts.check_your_answers_row('Genedigaeth a gofrestrwyd yn y DU')
    await asserts.check_your_answers_row('Tref neu ddinas geni')
    await asserts.check_your_answers_row('Enw’r fam')
    await asserts.check_your_answers_row('Enw’r tad a restrwyd')
    await asserts.check_your_answers_row('Enw’r tad')
    await asserts.check_your_answers_row('Mabwysiadwyd')
    await asserts.check_your_answers_row('Mabwysiadwyd yn y DU')
    await asserts.check_your_answers_row('Gwasanaeth cofrestru’r Lluoedd, Conswl Prydeinig neu Uchel Gomisiwn, neu dan ddarpariaethau '
    ...
    await asserts.check_your_answers_row('Birth name')
    await asserts.check_your_answers_row('Date of birth')
    await asserts.check_your_answers_row('Birth registered in UK')
    await asserts.check_your_answers_row('Town or city of birth')
    await asserts.check_your_answers_row("Mother's name")
    await asserts.check_your_answers_row("Father's name listed")
    await asserts.check_your_answers_row("Father's name")
    await asserts.check_your_answers_row('Adopted')
    await asserts.check_your_answers_row('Adopted in UK')
    await asserts.check_your_answers_row('Forces registering service, British Consul or High Commission, or under Merchant Shipping or '
    ...
    await asserts.check_your_answers_row('Dyddiad geni')
    await asserts.check_your_answers_row('Genedigaeth a gofrestrwyd yn y DU')
    await asserts.check_your_answers_row('Gwlad enedigol gofrestredig')
    await asserts.number_of_errors(0)
    ...
    await asserts.check_your_answers_row('Date of birth')
    await asserts.check_your_answers_row('Birth registered in UK')
    await asserts.check_your_answers_row('Registered birth country')
    await helpers.click_button('Cymraeg')
