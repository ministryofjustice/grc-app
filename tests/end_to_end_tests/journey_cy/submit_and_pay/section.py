...
async def run_checks_on_section(page: Page, asserts: AssertHelpers, helpers: PageHelpers):
    ...
    await asserts.check_your_answers_row(row_name="Ydych chi'n cydsynio i'r Swyddfa Gofrestru Gyffredinol gysylltu â chi ynglŷn â'ch cais?", expected_value='Oes')
