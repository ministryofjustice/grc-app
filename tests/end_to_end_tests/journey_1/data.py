...
CONTACT_DATE_SINGLE_YEAR = str((date.today() + relativedelta(month=1)).year)
...
CONTACT_DATE_RANGE_1_TO_YEAR = str((date.today() + relativedelta(month=1)).year)
...
CONTACT_DATE_RANGE_2_TO_YEAR = str((date.today() + relativedelta(month=1)).year)
