...
async def run_checks_on_page(page: Page, asserts: AssertHelpers, helpers: PageHelpers):
    ...
    # Continue to the "Marriage Documents" page again
    await helpers.click_button(TASK_LIST_BUTTON_NAME)
    ...
    # "Marriage documents" section should be marked as "NOT STARTED"
    ...
    # "Marriage documents" section should be marked as "COMPLETED"
