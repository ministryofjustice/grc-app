...
TASK_LIST_BUTTON_NAME = 'Name change documents'
PAGE_URL = '/upload/name-change'
PAGE_H1 = 'Upload name change documents'
...
async def run_checks_on_page(page: Page, asserts: AssertHelpers, helpers: PageHelpers):
    ...
    # "Name change documents" section should be marked as "NOT STARTED"
    ...
    # "Name change documents" section should be marked as "COMPLETED"
