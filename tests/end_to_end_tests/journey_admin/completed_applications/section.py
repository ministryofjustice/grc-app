...
async def run_checks_on_completed_section(page: Page, asserts: AssertHelpers, helpers: PageHelpers,
    ...
    await asserts.h2('Completed applications', '#completed h2')
    ...
    first_row_ref_num_completed = await admin_helpers.get_row_reference_number_from_link(first_row_completed)
    ...
    # second_row_reference_number_completed = await admin_helpers.get_row_reference_number_from_link(second_row_completed)
